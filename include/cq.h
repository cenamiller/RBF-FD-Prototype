...
void   cq_abort();                      // Prevents LLVM from doing something 
                                        // undesirable
void   cq_halt(const char*);            // Unexpected error.

void __cq_stack_check(void* stack);     // Check to see if the stack has been
extern void* stack_bottom;              // underflowed. 

// number of nanoseconds expired since some previous point in time
...
///////////////////////////////////////////////////////////////////////////////
// Error functions generated by dfgen
void cq_bad_func_ptr(int,...);          // attempt to call a null or otherwise
                                        // invalid function pointer.  Int
                                        // is the line number
...
{
   uint32_t z1 = dfsr_helper((uint32_t)seed, (uint32_t)seed+1);
